...
var ASM_CONSTS = {
 ...
 166478: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 166561: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 166630: () => { return window.innerWidth; },  
 166660: () => { return window.innerHeight; }
};
